...
<details>
  <summary>バージョンについて</summary>
  
  プログラミング言語やライブラリで利用されるバージョン管理（バージョニング）手法は**セマンティックバージョニング**と呼ばれています。  
  3つのセクションに区切られて表示されており、左にある数字ほど大規模な変更が含まれ、それぞれ以下のような意味があります。

  <img src="images/環境構築/セマンティックバージョン.png" width="600px" >  

  | バージョン | 説明 |
  |:--|:--|
  | **メジャーバージョン** | 大部分のデザインや機能が変更された時 |
  | **マイナーバージョン** | 一部機能の改善や細かい追加機能が実装された時 |
  | **パッチバージョン** | 軽微なバグ修正がされた時 |
...
**VirtualBoxがPCへすでにインストールしてある場合、ダウンロード・インストールは不要です。**
 ...
 1. 仮想環境の構築
    ...
    今回は以下のように設定していきましょう。  
      ...
      <img src="images/環境構築/virtualbox2.png" width="100%" >
      ...
      <img src="images/環境構築/virtualbox3.png" width="100%" >
 ...
 1. 仮想環境の設定～ログイン前
    ...
    時間が経つと次の画面が出てきます。  
    <img src="images/環境構築/virtualbox_ubuntuインストール1.png" width="100%" >

    左側の言語選択欄から`日本語`を選択します。  
    選択すると次の画面になります。  
    変わったのを確認できたら、`Ubuntuをインストール`ボタンをクリックします。
    <img src="images/環境構築/virtualbox_ubuntuインストール2.png" width="100%" >

    続いてキーボードの選択が表示されます。  
    入力欄にアットマーク(@)やダブルクオート(")等を入力してみましょう。  
    正しく表示されることを確認して`続ける`ボタンをクリックします。  
    <img src="images/環境構築/virtualbox_ubuntuインストール3.png" width="100%" >
    ...
    <img src="images/環境構築/virtualbox_ubuntuインストール4.png" width="100%" >

    
    `ディスクを削除してUbuntuをインストール`を選択して`インストール`をクリックします。

    <img src="images/環境構築/virtualbox_ubuntuインストール5.png" width="100%" >
    ...
    **仮想環境の中で作業をしているので、このディスクとは仮想環境の中の仮想ディスクのことです。**
    ...
    <img src="images/環境構築/virtualbox_ubuntuインストール6.png" width="100%" >


    続いては場所(タイムゾーン)の選択で`Tokyo`を選択します。

    <img src="images/環境構築/virtualbox_ubuntuインストール7.png" width="100%" >


    続いて利用する名前、コンピュータ名、パスワードを入力して`続ける`をクリックするとインストールが始まります。    
    名前とパスワードは忘れないようにしましょう。  

    <img src="images/環境構築/virtualbox_ubuntuインストール8.png" width="100%" >


    インストールにしばらく時間がかかります。
 
    <img src="images/環境構築/virtualbox_ubuntuインストール9.png" width="100%" >

    インストール完了のメッセージが表示されたら`今すぐ再起動する`ボタンをクリックします。

    <img src="images/環境構築/virtualbox_ubuntuインストール10.png" width="100%" >
    ...
    ```
    <img src="images/環境構築/virtualbox_ubuntuインストール11.png" width="100%" >
 ...
 1. 仮想環境へのログインとゲスト環境用追加ソフトウェアのインストール
    ...
    <img src="images/環境構築/virtualbox_ubuntuインストール12.png" width="100%" >
