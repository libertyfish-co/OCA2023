...
1. **ターミナルでrails new <アプリケーション名> コマンドでアプリケーション枠組みの作成**    
   ...
   「`rails new rails_app`」このコマンドをターミナルで実行してください。
    <img src="images/Rails基礎/rails new コマンド.png" width= "700px">  
     基本的なアプリケーションの枠組みが整いました。 

1. **rails db:createコマンドを実行**  

    「`rails db:create`」このコマンドをターミナルで実行してください。
   <img src="images/Rails基礎/rails dbcreate コマンド.png" width= "700px">  
...
1. **rails g scaffold コマンドで必要なファイルを一括作成**  
     ...
     <img src="images/Rails基礎/rails g コマンド.png" width= "700px">  
...
1. **rails db:migrate**  
    ...
    <img src="images/Rails基礎/rails dbmigrate コマンド.png" width= "700px">
...
1. **rails sコマンドでアプリを起動しましょう**  
   ...
   「`rails s`」このコマンドをターミナルで実行してください。
    ...
    <img src="images/Rails基礎/rails s コマンド.png" width= "700px">  
...
`rails new`コマンドを実行すると、Railsはアプリケーションに必要な
**ディレクトリ（フォルダ）**
や**ファイル**を自動的に作成し、開発環境を整えてくれます。

 <img src="images/Rails基礎/アプリケーション 構成 .png" width= "700px">
   

このコマンドで作成された主なディレクトリ（フォルダ）やファイルの役割のについて説明していこうと思います。

では、作成したアプリケーションの中身を見てみましょう。

<img src="images/Rails基礎/appディレクトリ.png" width= "300px">
