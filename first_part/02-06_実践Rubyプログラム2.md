...
##### HPに最低値をもたせよう
ダメージ処理を繰り返していくとそのうちHPがマイナスになってしまうので、`0`で止まるように処理を`receive_damage`に加えましょう。また、同時にこうげき対象キャラクターの生存フラグも下ろして、死滅にします。
...
#### 逃げたらゲームを終わらせよう
先ほど作った`@escape_flg`を勇者のターンのメソッド処理が終わったら確認して、もしフラグが立っていたらループを抜けます。
