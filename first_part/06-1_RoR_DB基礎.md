...
- [6.1 Ruby on Rails：データベース基礎](#61-ruby-on-railsデータベース基礎)
  - [目次](#目次)
    - [(1) データベースとは](#1-データベースとは)
      - [IT分野におけるデータベース](#it分野におけるデータベース)
      - [データベースの重要性](#データベースの重要性)
    - [(2) データベースの基礎](#2-データベースの基礎)
      - [データベースの特徴](#データベースの特徴)
      - [リレーショナル・データベースとは](#リレーショナルデータベースとは)
      - [リレーショナル・データベースの特徴](#リレーショナルデータベースの特徴)
        - [データベースの構造](#データベースの構造)
    - [(3) ActiveRecord](#3-activerecord)
      - [ActiveRecordとは](#activerecordとは)
      - [ORMとは](#ormとは)
      - [ActiveRecordの主な機能](#activerecordの主な機能)
    - [(4) SQLとActiveRecordの比較](#4-sqlとactiverecordの比較)
      - [SQLでの例](#sqlでの例)
      - [ActiveRecordでの例](#activerecordでの例)
      - [詳細な説明](#詳細な説明)
      - [SQLの仕組み](#sqlの仕組み)
      - [ActiveRecordの仕組み](#activerecordの仕組み)
      - [ActiveRecordの直感的な利便性](#activerecordの直感的な利便性)
    - [(5) ActiveRecordの代表的なメソッド](#5-activerecordの代表的なメソッド)
    - [まとめ](#まとめ)
    - [例題](#例題)
      - [①　アプリケーションの作成](#アプリケーションの作成)
      - [②　Teacherモデルの作成](#teacherモデルの作成)
      - [③　Lessonモデルの作成](#lessonモデルの作成)
      - [③　TeacherLessonモデルの作成](#teacherlessonモデルの作成)
    - [(6) 問題](#6-問題)
...
<img src="images/DB基礎/DB基礎解説図4.png" width= "600px">  
