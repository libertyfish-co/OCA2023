...
### ゲームの流れ
ゲームをプログラミングするにあたって、まずは流れの把握をしましょう。以下のフローチャートは流れを簡単に表したものです。

<img src="images/実践Rubyプログラム/フロー.png" width="500px">

プログラムのおおよその流れを理解した上でコーディングすることは非常に大切です。流れを整理することで、スムーズなコーディングを行うことができます。
